                ...
                <form id="integrationsForm" onsubmit="submitIntegrations(event)" class="space-y-6">
                    ...
                    <div class="card-minimal p-5 flex flex-col gap-4">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="/admin/automations" class="shrink-0 bg-brand-900 text-white text-xs font-bold px-4 py-2.5 rounded-xl hover:bg-brand-800 transition-colors shadow-minimal flex items-center gap-1">
