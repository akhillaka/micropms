...
$duesQuery = "SELECT SUM(fl.amount) FROM folio_ledger fl JOIN bookings b ON fl.booking_id = b.id WHERE b.property_id = " . (int)$propertyId;
...
$unpaidQuery = "
    ...
    WHERE b.property_id = " . (int)$propertyId . "
...
$incStmt = $db->query("SELECT key_value FROM system_settings WHERE key_name = 'FINANCE_INCOME_CATEGORIES' AND property_id = 1");
...
$expStmt = $db->query("SELECT key_value FROM system_settings WHERE key_name = 'FINANCE_EXPENSE_CATEGORIES' AND property_id = 1");
            ...
            <div class="grid grid-cols-1 sm:grid-cols-4 gap-4">
                <div class="card-minimal p-5 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-semibold text-brand-900">₹<?= htmlspecialchars((string)(number_format($totalRevenue, 2)), ENT_QUOTES, 'UTF-8') ?></p>
                    </div>
                </div>
                <div class="card-minimal p-5 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-semibold text-error-600">₹<?= htmlspecialchars((string)(number_format($totalExpense, 2)), ENT_QUOTES, 'UTF-8') ?></p>
                    </div>
                </div>
                <div class="card-minimal p-5 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-semibold <?= htmlspecialchars((string)($netProfit >= 0 ? 'text-blue-600' : 'text-error-600'), ENT_QUOTES, 'UTF-8') ?>">₹<?= htmlspecialchars((string)(number_format($netProfit, 2)), ENT_QUOTES, 'UTF-8') ?></p>
                    </div>
                </div>
                ...
                <div class="overflow-x-auto rounded-2xl border border-slate-100">
                    <table class="w-full text-left border-collapse bg-white whitespace-nowrap">
                        ...
                        <tbody class="divide-y divide-gray-50" id="desktopLedger">
                            ...
                            <tr class="hover:bg-brand-50 transition-colors desktop-row" data-type="<?= htmlspecialchars((string)($t['type'])) ?>" data-method="<?= htmlspecialchars((string)($t['payment_method'] ?? '')) ?>">
