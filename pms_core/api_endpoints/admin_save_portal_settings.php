...
ApiHandler::run(function(\PDO $db) {
    ...
    $settings = [
        ...
        'GUEST_PORTAL_WIFI_ENABLED'          => ($data['wifi_enabled'] ?? false) ? 'true' : 'false',
        'GUEST_PORTAL_SIGHTSEEING_ENABLED'   => ($data['sightseeing_enabled'] ?? false) ? 'true' : 'false',
        'GUEST_PORTAL_WAKEUP_ENABLED'        => ($data['wakeup_enabled'] ?? false) ? 'true' : 'false',
        'GUEST_PORTAL_EXTEND_STAY_ENABLED'   => ($data['extend_stay_enabled'] ?? false) ? 'true' : 'false',
        'GUEST_PORTAL_UPGRADE_ENABLED'       => ($data['upgrade_enabled'] ?? false) ? 'true' : 'false',
        'GUEST_PORTAL_CONTACT_ENABLED'       => ($data['contact_enabled'] ?? false) ? 'true' : 'false',
